...
class Maze:
    ...
    def __init__(self, maze, start_cell=(0, 0), exit_cell=None, train=True):
        print("Inside maze: ", start_cell, exit_cell)
        ...
        # print("self.empty: ", self.empty, self.__exit_cell)
    ...
    def reset(self, start_cell=(0, 0)):
        ...
        # print("\n\n\nMaze.py\n\n", self.maze, self.__exit_cell, start_cell)
