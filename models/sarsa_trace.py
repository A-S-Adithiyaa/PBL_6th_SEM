...
class SarsaTableTraceModel(AbstractModel):
    ...
    def train(self, stop_at_convergence=False, **kwargs):
        ...
        exploration_rate = kwargs.get("exploration_rate", 0.70)
        exploration_decay = kwargs.get("exploration_decay", 0.05)  # % reduction per step = 100 - exploration decay
        learning_rate = kwargs.get("learning_rate", 0.99)
